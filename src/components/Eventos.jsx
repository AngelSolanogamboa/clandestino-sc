...
import { Calendar, MapPin, Clock, Ticket, ChevronRight,X } from 'lucide-react'

const eventos = [
  {
    id: 1,
    titulo: 'Clandestino Night Vol. 1',
    fecha: '2025-07-12',
    hora: '22:00',
    lugar: 'Club Underground',
    ciudad: 'Tuxtla Gutiérrez, Chis.',
    descripcion: 'Primera edición de nuestra noche oficial. Techno industrial y dark ambient en el mejor venue de la ciudad.',
    lineup: ['DJ Skull', 'La Parca', 'Miembro 3'],
    ticketUrl: '#',
    estado: 'proximo',
    imagen: 'https://placehold.co/800x400/1a1a1a/FF5B00?text=Clandestino+Night+Vol.1',
  },
  {
    id: 2,
    titulo: 'Warehouse Session',
    fecha: '2025-08-02',
    hora: '23:00',
    lugar: 'Bodega Central',
    ciudad: 'San Cristóbal, Chis.',
    descripcion: 'Sesión íntima en una bodega industrial. Cupo limitado para una experiencia underground auténtica.',
    lineup: ['DJ Skull', 'La Parca'],
    ticketUrl: '#',
    estado: 'proximo',
    imagen: 'https://placehold.co/800x400/1a1a1a/FF5B00?text=Warehouse+Session',
  },
  {
    id: 3,
    ...
    ciudad: 'Tuxtla Gutiérrez, Chis.',
    descripcion: 'Participación especial en el festival de arte urbano de la ciudad.',
    lineup: ['DJ Skull', 'La Parca', 'Miembro 3', 'Miembro 4'],
    ticketUrl: null,
    estado: 'pasado',
    imagen: 'https://placehold.co/800x400/1a1a1a/FF5B00?text=Festival+Arte+Urbano',
  },
]
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{
          color: esProximo ? 'rgba(0,0,0,0.6)' : 'rgba(255,255,255,0.4)',
          fontSize: '0.7rem',
          marginTop: '0.1rem',
        }}>
          {año}
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '1.25rem', marginTop: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <span style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#f5f5f5', opacity: 0.5, fontSize: '0.8rem' }}>
            <MapPin size={13} /> {evento.lugar}, {evento.ciudad}
          </span>
        </div>
            ...
            >
              ...
              <div style={{ padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', margin: '1rem 0' }}>
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#f5f5f5', opacity: 0.6, fontSize: '0.85rem' }}>
                    <MapPin size={15} color="#FF5B00" /> {selected.lugar}, {selected.ciudad}
                  </span>
                </div>
